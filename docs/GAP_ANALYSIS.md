...
Postgres, Redis, live chain adapters, session/OIDC, file/KMS keystore, webhook retries, explorer primitives, and OTV-0010 conformance landed after this snapshot. Current truth is `AGENTS.md`, `docs/README.md`, `docs/PENDING.md`, `docs/MVP_BOUNDARIES.md`, and the code.
